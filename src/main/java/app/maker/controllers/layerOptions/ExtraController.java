...
public class ExtraController extends OptionLayerController {

    @FXML private Accordion extraOptionsRoot;
    ...
    public void updateLanguage() {
        titledPaneImage.setText(TranslationM.getTranslatedLabel("title_extra_image"));
        buttonImage.setText(TranslationM.getTranslatedLabel("button_select_image"));
        labelImage.setText(TranslationM.getTranslatedLabel("label_extra_image"));
        checkboxImage.setText(TranslationM.getTranslatedLabel("checkbox_extra_image"));
        tooltipCImage.setText(TranslationM.getTranslatedLabel("tooltip_extra_cimage"));
    }
}
